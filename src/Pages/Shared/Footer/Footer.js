        ...
        <div className='App mt-9'>
            ...
            <footer className="p-4 bg-white sm:p-6 dark:bg-gray-900">
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            ...
                            <ul className="text-gray-600 dark:text-gray-400">
                                <li className="mb-4">
                                    <p href="https://flowbite.com/" className="hover:underline">DaisyUi</p>
                                </li>
                                <li>
                                    <p href="https://tailwindcss.com/" className="hover:underline">Tailwind CSS</p>
                                </li>
                            </ul>
                        </div>
                        <div>
                            ...
                            <ul className="text-gray-600 dark:text-gray-400">
                                <li className="mb-4">
                                    <p href="https://github.com/themesberg/flowbite" className="hover:underline ">Github</p>
                                </li>
                                <li>
                                    <p href="https://discord.gg/4eeurUVvTy" className="hover:underline">Discord</p>
                                </li>
                            </ul>
                        </div>
                        <div>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <p href="https://flowbite.com/" className="hover:underline">Arnob Wild-Graphy™</p>. All Rights Reserved.
                    </span>
                    <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                        <p href="#" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
